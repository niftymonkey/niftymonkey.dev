  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-1">
        <span className="hidden sm:block text-terminal-gray text-xs w-20 shrink-0">
      ...
      <div className="ml-0 sm:ml-24 text-foreground text-sm mb-1">{project.description}</div>
      <div className="ml-0 sm:ml-24 text-terminal-amber text-xs">
        {project.tech.join(' | ')}
      </div>
    </a>
  );
